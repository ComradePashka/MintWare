...
export default function RewardAndTransaction(): ReactElement {
            ...
            <div role="tabpanel" className="tab-content mt-4">
              ...
              <div className="flex mt-6">
                ...
                <div className="flex-0">
                  ...
                  <button
                    className="btn btn-md w-[160px] btn-primary text-white rounded rounded-tl-[8px] rounded-tr-[16px] rounded-bl-[16px] rounded-br-[8px] ml-2"
                    onClick={() =>
                      (
